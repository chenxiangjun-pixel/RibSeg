...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=4, help='Batch size during testing')
    parser.add_argument('--gpu', type=str, default='0', help='GPU to use')
    parser.add_argument('--log_dir', type=str, default=r"./log", help='Directory containing best_model.pth')
