...
def main():
    ...
    parser.add_argument('--root', default=r'E:\Code_collection\8_Rib_seg\RibSeg\dataset\seg_input_10w', help='数据集根目录')
    ...
    print(df)
    df.to_excel(r'E:\Code_collection\8_Rib_seg\RibSeg\dataset\label_distribution.xlsx', index=False)
